algorithm tilemap(
    ...
    uint1   tmpixel <: colour15(colours.rdata0).x_reflect ? tiles16x16.rdata0[xintm, 1] :tiles16x16.rdata0[ ~xintm, 1 ];
    ...
    tiles16x16.addr0 := colour15(colours.rdata0).y_reflect ? { tiles.rdata0, ~yintm } :{ tiles.rdata0, yintm };
